...
public class BadAnswer extends Answers
{
    ...
    void update(){//update pt fiecare operatie
        ...
        int random = getRandomNumber(max(1, result - 20), result + 10);
    ...
    easy e;//clasa pt buton de lv usor
    hard h;//clasa pt buton de lv mediu
    medium m;//clasa pt buton de lv greu
    ...
    {   
       ...
       if(getX() < 10){
           update();//in cazul in care actorul este prea aproape de margine
       }
    }
}
